#ifndef OPENSIM_ZEROMOMENTPOINTCONTACTFORCE_H_
#define OPENSIM_ZEROMOMENTPOINTCONTACTFORCE_H_
/* -------------------------------------------------------------------------- *
 *                   OpenSim: ZeroMomentPointContactForce.h                   *
 * -------------------------------------------------------------------------- *
 ...
 * @version 1.0
 */
class OSIMSIMULATION_API ZeroMomentPointContactForce : public Force {
    OpenSim_DECLARE_CONCRETE_OBJECT(ZeroMomentPointContactForce, Force);
...
public:
    ...
    /** Default constructor */
    ZeroMomentPointContactForce();

    /** Constructor with object name and ZMP Ground Reactions socket */ 
    ZeroMomentPointContactForce(const std::string& name,
...
//=============================================================================
}; // END of class ZeroMomentPointContactForce
//=============================================================================
//=============================================================================

} // namespace OpenSim

#endif // OPENSIM_ZEROMOMENTPOINTCONTACTFORCE_H_
