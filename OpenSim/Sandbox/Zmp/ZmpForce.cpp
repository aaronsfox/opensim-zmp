...
ZmpForce::ZmpForce(const std::string& name,
...
void ZmpForce::constructProperties()
{
...
void ZmpForce::extendConnectToModel(Model& model)
{
    ...
    if (!_appliedToBody) {
        throw(Exception("ZmpForce: Could not find body '" +
...
void ZmpForce::extendAddToSystem(
    ...
    ZmpForce* mutableThis =
            const_cast<ZmpForce*>(this);
...
//void OpenSim::ZmpForce::extendRealizeInstance(
...
void ZmpForce::computeForce(const SimTK::State& state,
...
//const double& ZmpForce::getForceMagnitude(
//        const SimTK::State& s) {
...
Array<std::string> ZmpForce::getRecordLabels() const {
...
Array<double> ZmpForce::getRecordValues(
        const SimTK::State& state) const {
...
//SimTK::Vector ZmpForce::getContactBodyForce(
//        const SimTK::State& state) const {
//
...
//void ZmpForce::generateDecorations(bool fixed,
